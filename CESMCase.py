...
class CESMCase(object):
    ...
    def __init__(self, case):
        ...
        """
        self.CESMHOME = "/scratch/project/c/ccsm/ccsm4_current/"
        self.CCSMSRC = "/scratch/project/c/ccsm/ccsm4_current/"
        self.CASE     = case
        self.CASEROOT = osp.join("/reserved1/p/peltier/guido/runs/", self.CASE)
        self.RESERVED = "/reserved1/p/peltier/guido/"
        self.RES = "/reserved1/p/peltier/guido/"
        self.SCRATCH  = "/scratch/p/peltier/guido/"
        self.HOME  = "/home/p/peltier/guido/"
